...
public class CoffeescriptConcatIntegrationTest {

	CoffeescriptConcat concat;
	...
	String noDepsString;
	String animalString;
	private VirtualFile snake;
	private String snakeString;
	private VirtualFile python;
	private String pythonString;
	private VirtualFile requireDirective;
	
	@Before
	public void setup() throws Exception {
		concat = new CoffeescriptConcat();
